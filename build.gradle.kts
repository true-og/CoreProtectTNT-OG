...
/* ----------------------------- Metadata ------------------------------ */
group = "net.trueog.coreprotecttnt-og" // Declare bundle identifier.
...
repositories {
    ...
    maven {
        url = uri("https://maven.playpro.com/") // Import the CoreProtect Maven repository.
    }
}
...
dependencies {
    ...
    compileOnly("net.coreprotect:coreprotect:22.4") // Import CoreProtect API.
}
